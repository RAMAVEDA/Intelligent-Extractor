...
class Report(models.Model):
    ...
    documentcount = models.IntegerField(default=0)
    modelname = models.CharField(max_length=100)
    extractionstatus = models.CharField(max_length=100)
...
class AllReport(models.Model):
    eachname = models.CharField(max_length=100)
    reportname = models.CharField(max_length=100)
    extractedvaluecount = models.IntegerField(default=0)
    extractedvalue = models.CharField(max_length=10000)
